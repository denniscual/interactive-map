...
const InteractiveMapsContext = React.createContext<types.InteractiveMaps>(
  initData
)
const InteractiveMapsDispatchContext = React.createContext<
  types.InteractiveMapsDispatch
>(() => {})
...
const useInteractiveMapsDispatch = () =>
  React.useContext(InteractiveMapsDispatchContext)

export {
  InteractiveMapsProvider,
  useInteractiveMaps,
  useInteractiveMapsDispatch,
}
