...
<g id="stores">
  <path id="point-of-sale" data-label="Point of Sale" className="area store-area" d="M1683,772l-56.5,70.39h-75.59V726.14l128.81-59.82Z"/>
  <path id="woc" data-label="WOC" className="area store-area" d="M1770.25,1502.86v383a253.3,253.3,0,0,0-27,0,192,192,0,0,1-21.85.61,187.92,187.92,0,0,1-49.9-8.43V1502.73Z"/>
  <path id="souvenirs" data-label="Souvenirs" className="area store-area" d="M1805.6,963.71l-35.35,6.08-29.45,64.4H1620.38v-98H1447.3v-162L1551,726.14V842.41h75.46L1683,772C1760.6,836.91,1795.25,902.93,1805.6,963.71Z"/>
  <path id="contentainment" data-label="Contentainment" className="area store-area" d="M2251.94,1752.32v120.29a268.83,268.83,0,0,0-51.91,17.08s-40.85,16.21-80.61,27.49c-5.81,1.66-17.48,4.8-33.65,7.73v-401.6h143.67v191.82Z"/>
  <path id="toys" data-label="Toys" className="area store-area" d="M750.68,1539.52H634.58V1406.78H746C746.13,1487.7,749,1506,750.68,1539.52Z"/>
  <rect id="cigarettes" data-label="Cigarettes" className="area store-area" x="745.74" y="2267.26" width="156.78" height="188.89"/>
  <path id="tobacco" data-label="Tobacco" className="area store-area" d="M1550.86,2160.25v295.9H902.52V2267.26H626.23V2223H756.36l49.15,27.13h406.67l122.35-124.22c20.4,9.87,32.07,17,66.2,27.44,60.16,18.39,91.75,16.91,107.7,15.2A189.28,189.28,0,0,0,1550.86,2160.25Z"/>
  <path id="perfumes-and-cosmetics-promotion" data-label="Perfumes and Cosetics Promotion" className="area store-area" d="M2658.09,1978.26a96.13,96.13,0,1,1-96.13-96.13A96.13,96.13,0,0,1,2658.09,1978.26Z"/>
  <path id="liquor-promotion" data-label="Liquor Promotion" className="area store-area" d="M1560.91,1978.26a96.13,96.13,0,1,1-96.13-96.13A96.13,96.13,0,0,1,1560.91,1978.26Z"/>
  <polygon id="alcoholic-beverages-promotion" data-label="Alcoholic Beverages Promotion" className="area store-area" points="1171.55 1078.76 1171.55 1315.32 1094.21 1315.32 1077.82 1325.42 1029.19 1325.42 1029.19 1078.76 1171.55 1078.76"/>
...
// TODO:
// - we need to add original categgory id into `data-categories`
// - in the client side, maybe in the provider, we gonna parse the categories of every area.
